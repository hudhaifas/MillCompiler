...
/**
 * An extended of <code>javax.swing.JFrame</code> that adds support for the JFC/Swing component architecture. You can
 * find task-oriented documentation about using <code>JFrame</code> in <em>The Java Tutorial</em>, in the section
 * <a href="http://java.sun.com/docs/books/tutorial/uiswing/components/frame.html">How to Make Frames</a>. The
 * <code>Runnable</code> interface implemented by ServerFrame class to be executed by a thread. The class must define a
 * method of no arguments called <code>run</code>.
 *
 ...
 * which can be minimized to an icon.
 *
 * @version 1.0
...
public class MainFrame
    ...
    /**
     * Creates a new, initially invisible <code>MainFrame</code> with the specified title.
     * <p>
    ...
    /**
     * The listener class for receiving action events. The class that is interested in processing an action event and
     * the object created with that class is registered with a component, using the component's
     * <code>addActionListener</code> method. When the action event occurs, that object's <code>actionPerformed</code>
     * method is invoked.
     *
     * @see java.awt.event.ActionEvent
     * @see <a href="http://java.sun.com/docs/books/tutorial/post1.0/ui/eventmodel.html">Tutorial: Java 1.1 Event
     * Model</a>
     * @see <a href="http://www.awl.com/cp/javaseries/jcl1_2.html">Reference: The Java Class Libraries ( update file
     * )</a>
     * @since 1.0
     */
