 ...
 * while the application setup  it's sitting. It does not have the title bar, window-management buttons,
...
public class Splash
    ...
    /**
     * Creates a splash with no specified owner. This window will not be
     * focusable.
     * <p>
